...
| **H. カメラ入力** | 「顔で操作したい」「カメラで体を読む」「MediaPipe」「手をかざして」「認識が不安定」 | `references/core/camera-input.md` |
...
| `references/core/camera-input.md` | 経路H。顔・手・全身をカメラで読む。正規化、ヒステリシス、One Euro、遅延予算、無言キャリブレーション、疲労、プライバシー |
